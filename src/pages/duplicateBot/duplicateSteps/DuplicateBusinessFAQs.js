...
const DuplicateBusinessFAQs = ({ onNext, goPrevious }) => {
  ...
  const goNext = () => {
    ...
    localStorage.setItem("dupfaqs", JSON.stringify(formdata));
  };
  useEffect(() => {
    setInitialData(JSON.parse(localStorage.getItem("dupfaqs")));
  }, []);
...
export default DuplicateBusinessFAQs;
