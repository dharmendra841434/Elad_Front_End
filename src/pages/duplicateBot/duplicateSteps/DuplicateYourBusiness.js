...
const DuplicateYourBusiness = ({ onNext, goPrevious }) => {
  ...
  const {
    ...
    initialValues: {
      ...
      countryISO: initialData != null ? initialData.countryISO : "USA",
      totalBranches:
        initialData != null
  ...
  const goNext = () => {
    ...
    localStorage.setItem("dupyourBusiness", JSON.stringify(formdata));
  };

  useEffect(() => {
    setInitialData(JSON.parse(localStorage.getItem("dupyourBusiness")));
  }, []);
...
export default DuplicateYourBusiness;
