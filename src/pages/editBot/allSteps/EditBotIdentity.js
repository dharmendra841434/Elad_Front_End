...
const EditBotIdentity = ({ onNext }) => {
  ...
  const goNext = (values) => {
    ...
    localStorage.setItem("editBotIdentity", JSON.stringify(formdata));
  };
  ...
  useEffect(() => {
    ...
    setInitialData(JSON.parse(localStorage.getItem("editBotIdentity")));
  }, []);
...
export default EditBotIdentity;
