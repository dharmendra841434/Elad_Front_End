...
const EditYourBusiness = ({ onNext, goPrevious }) => {
  ...
  const goNext = () => {
    ...
    localStorage.setItem("edityourBusiness", JSON.stringify(formdata));
  };

  useEffect(() => {
    setInitialData(JSON.parse(localStorage.getItem("edityourBusiness")));
  }, []);
